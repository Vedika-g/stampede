...
def show_header():
    st.title("🚨 AI Stampede Early Warning System")

    st.caption(
        "Real-time crowd intelligence • Density analysis • "
        "Movement detection • Predictive risk monitoring"
    )
...
def show_sidebar():
    ...
    with st.sidebar:
        ...
        st.markdown("## 🛡️ CROWDGUARD")

        st.caption("AI-Powered Crowd Safety Platform")
        ...
        st.write("🎯 **YOLOv8m**")
        st.caption("Person detection & tracking")

        st.write("🧠 **CSRNet**")
        st.caption("Crowd density estimation")

        st.write("🏃 **Optical Flow**")
        st.caption("Movement analysis")

        st.write("⚠️ **Risk Engine**")
        st.caption("Stampede risk prediction")
        ...
        try:
            ...
            if torch.cuda.is_available():
                ...
                try:
                    ...
                    st.caption("NVIDIA GPU detected")
            ...
            st.info("Hardware information unavailable")
        ...
        st.caption("YOLO interval: 3 frames")
        st.caption("CSRNet interval: 10 frames")
        st.caption("Optical Flow interval: 3 frames")

        st.divider()

        st.caption("CrowdGuard v1.0")
        st.caption("AI-Based Stampede Early Warning System")
...
def show_section_title(title, description=None):
...
def update_score_cards(columns, risk):

    people_score = float(
        risk.get("people_score", 0)
    )

    density_score = float(
        risk.get("density_score", 0)
    )

    movement_score = float(
        risk.get("movement_score", 0)
    )
...
def show_risk_progress(risk_score):
...
def show_footer():
    ...
    st.caption(
        "CrowdGuard • AI-Based Stampede Early Warning System"
    )
